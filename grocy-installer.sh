...
echo
echo "Installing dependencies..."
# sudo pacman -Syu --needed --noconfirm nginx php-fpm php-gd php-intl php-sqlite sqlite unzip
echo
echo
echo
echo
...
sudo cp /var/lib/grocy/config-dist.php /var/lib/grocy/data/config.php
sudo chown -R http:http /var/lib/grocy
echo
echo
echo
echo
